...
<body>
    ...
    <div class="register-photo" style="color: rgb(0,0,0);">
        ...
        <div class="form-container" style="margin-top: 100px;">
            <form action="/cadastroAnuncio" method="post">
                <div class="form-group">
                    <h4 style="font-family: Roboto, sans-serif;font-weight: bold;font-size: 20px;">Coloque o nome do seu produto ou serviço*</h4><input class="form-control" type="text" name="nome" placeholder="Produto/serviço"></div>
                ...
                <div class="form-group" style="margin-top: 30px;">
                    <h4 style="font-family: Roboto, sans-serif;font-weight: bold;font-size: 20px;">Insira o telefone que seus clientes poderão contactar a empresa</h4><input class="form-control" type="telephone" name="telefone" placeholder="(__)_____-____"></div>
    ...
    <div class="form-group"><a class="btn btn-primary btn-block" role="button" href="formulario_ok.jsp">Enviar</a></div>
    </form>
    </div>
    <!-- End: Form Container -->
    </div>
