...
<body style="background-color: rgba(32,30,45,0.9);">
    ...
    <div class="container">
        <div class="carousel slide carousel-fade" data-ride="carousel" data-interval="false" data-aos="fade-up" data-aos-duration="750" data-aos-delay="50" id="carousel-1">
            <div class="carousel-inner" role="listbox" style="background-size: auto;">
                <div class="carousel-item active" style="background-size: auto;"><img class="w-100 d-block" src="assets/img/anuncio4-1.png" alt="Slide Image" height="600px" style="opacity: 1;filter: brightness(60%) contrast(110%) saturate(95%);background-repeat: repeat;background-size: auto;"></div>
                <div class="carousel-item"><img class="w-100 d-block" src="assets/img/anuncio4-2.png" alt="Slide Image" height="600px" style="filter: brightness(60%) contrast(110%) saturate(95%);"></div>
            </div>
            <div>
                <!-- Start: Previous --><a class="carousel-control-prev" href="#carousel-1" role="button" data-slide="prev" style="opacity: 1;filter: brightness(100%) contrast(100%) saturate(100%);"><span class="carousel-control-prev-icon"></span><span class="sr-only">Previous</span></a>
                <!-- End: Previous -->
                <!-- Start: Next --><a class="carousel-control-next" href="#carousel-1" role="button" data-slide="next" style="opacity: 1;filter: brightness(100%);"><span class="carousel-control-next-icon"></span><span class="sr-only">Next</span></a>
                <!-- End: Next -->
            </div>
        ...
        <div style="height: 20px;background-color: rgba(63,98,9,0.9);"></div>
    </div>
    <div class="container">
        <div class="carousel slide carousel-fade" data-ride="carousel" data-interval="false" data-aos="fade-up" data-aos-duration="750" data-aos-delay="50" id="carousel-2">
            <div class="carousel-inner" role="listbox" style="filter: brightness(60%) contrast(110%) saturate(95%);">
                <div class="carousel-item active"><img class="w-100 d-block" src="assets/img/anuncio5-1.jpg" alt="Slide Image" height="600px"></div>
                <div class="carousel-item"><img class="w-100 d-block" src="assets/img/anuncio5-2.jpg" alt="Slide Image" height="600px"></div>
            </div>
            <div>
    ...
    <div class="container">
        <div class="carousel slide carousel-fade" data-ride="carousel" data-interval="false" data-aos="fade-up" data-aos-duration="750" data-aos-delay="50" id="carousel-3">
            <div class="carousel-inner" role="listbox" style="filter: brightness(60%) contrast(110%) saturate(95%);">
                <div class="carousel-item active"><img class="w-100 d-block" src="assets/img/anuncio3.jpg" alt="Slide Image" height="600px"></div>
                <div class="carousel-item"><img class="w-100 d-block" src="assets/img/anuncio3-1.png" alt="Slide Image" height="600px"></div>
                <div class="carousel-item"><img class="w-100 d-block" src="assets/img/anuncio3-2.png" alt="Slide Image" height="600px"></div>
            </div>
            <div>
    ...
    </div><button class="btn btn-dark btn-block btn-lg text-center border rounded border-success" type="button" style="font-family: Roboto, sans-serif;font-weight: bold;font-size: 20px;letter-spacing: 1.5px;">MAIS</button>
